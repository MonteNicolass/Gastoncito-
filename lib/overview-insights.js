 ...
 * Money Insights
 */
export function getMoneyOverview(movimientos, categorias) {
  const now = new Date()
 ...
 */
export function getAllOverviewData(movimientos, lifeEntries, categorias, goals, behaviorInsights) {
  return {
    money: getMoneyOverview(movimientos, categorias),
